  ...
  const tiers = [
    {
      ...
      price: "29",
      perPool: "1,50",
      desc: "Para piscineros solos con hasta ~60 piscinas.",
      features: ["Rutas y parte químico", "Informes SILOÉ", "WhatsApp básico", "Bizum + transferencia"],
      featured: false,
    },
    {
      name: "Equipo",
      price: "79",
      perPool: "1,20",
      desc: "Empresas con 2–5 técnicos y comunidades.",
      features: ["Todo lo anterior", "Agente WhatsApp con IA", "Stripe + SEPA + VeriFactu", "Portal cliente y comunidades", "Optimización de rutas IA"],
      featured: true,
    },
    {
      name: "Profesional",
      price: "199",
      perPool: "0,90",
      desc: "Operadores con +500 vasos, hoteles y multinacionales.",
      features: ["Todo lo anterior", "Multi-sede y multi-NIF", "API y exportaciones a ERP", "Soporte prioritario y SLA", "Gestor de cuenta dedicado"],
      featured: false,
    },
  ];
  return (
